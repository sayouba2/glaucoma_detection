...
export default function Signup() {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            // ✅ La correction (on attend juste que ça finisse, sans stocker le résultat)
    ...
    // NOUVEAU DESIGN CENTRÉ
    return (
        // 1. Conteneur plein écran (min-h-screen)
        // 2. Padding haut (pt-24) pour éviter la navbar
        // 3. Centrage Flexbox
